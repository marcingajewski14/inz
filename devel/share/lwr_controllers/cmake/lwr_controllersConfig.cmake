...
if("TRUE" STREQUAL "TRUE")
  set(lwr_controllers_SOURCE_PREFIX /home/marcin/kuka-lwr/src/lwr_controllers)
  set(lwr_controllers_DEVEL_PREFIX /home/marcin/kuka-lwr/devel)
  ...
  set(lwr_controllers_INSTALL_PREFIX /home/marcin/kuka-lwr/install)
...
if(NOT "/home/marcin/kuka-lwr/devel/include;/home/marcin/kuka-lwr/src/lwr_controllers/include " STREQUAL " ")
  set(lwr_controllers_INCLUDE_DIRS "")
  set(_include_dirs "/home/marcin/kuka-lwr/devel/include;/home/marcin/kuka-lwr/src/lwr_controllers/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lwr_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/marcin/kuka-lwr/src/lwr_controllers/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT lwr_controllers_NUM_DUMMY_TARGETS)
      set(lwr_controllers_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::lwr_controllers::wrapped-linker-option${lwr_controllers_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR lwr_controllers_NUM_DUMMY_TARGETS "${lwr_controllers_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::lwr_controllers::wrapped-linker-option${lwr_controllers_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND lwr_controllers_LIBRARIES "${interface_target_name}")
